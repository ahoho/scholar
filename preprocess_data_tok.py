...
def main(args):
    ...
    parser.add_option('--tokenized', action="store_true", dest="tokenized", default=False,
                      help='Use tokenized_text json element instead of tokenizing text: default=%default')
    ...
    preprocess_data(train_infile, test_infile, output_dir, train_prefix, test_prefix, min_doc_count, max_doc_freq, vocab_size, stopwords, tokenized, keep_num, keep_alphanum, strip_html, lower, min_length, label_fields=label_fields)
